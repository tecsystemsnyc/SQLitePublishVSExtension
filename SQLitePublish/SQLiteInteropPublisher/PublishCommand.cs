...
namespace SQLiteInteropPublisher
{
    /// <summary>
    /// Command handler
    /// </summary>
    internal sealed class PublishCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("9ceb7ea4-5671-4f59-b7bb-836f962f584b");
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            string message = string.Format(CultureInfo.CurrentCulture, "Publish path: {0}", path);
